 ...
 */
public class CommandCart extends Command {

	public CommandCart() {
		super(AllowedExecutor.PLAYER, Settings.CMD_ALIAS_SUB_CART.getStringList().toArray(new String[0]));
	}
	...
	public String getPermissionNode() {
		return "auctionhouse.cmd.cart";
	}

	@Override
	public String getSyntax() {
		return AuctionHouse.getInstance().getLocale().getMessage("commands.syntax.cart").getMessage();
	}

	@Override
	public String getDescription() {
		return AuctionHouse.getInstance().getLocale().getMessage("commands.description.cart").getMessage();
	}
