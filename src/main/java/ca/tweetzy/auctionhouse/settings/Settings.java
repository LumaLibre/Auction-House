...
//	public static final ConfigSetting DISABLE_PLAYER_REF_UPDATE_MSG = new ConfigSetting(config, "auction setting.disable player reference update message", false, "If true, auction house will not log the player reference updates to the console");
	...
	public static final ConfigSetting OFFLINE_NOTIFICATIONS_ENABLED = new ConfigSetting(config, "auction setting.offline notifications enabled", true, "When a player is offline, queue auction notifications (item sold, outbid, bid placed, etc.) and deliver them when they next join.");
	...
	public static final ConfigSetting MAIN_AH_ITEM_CLICK_COOLDOWN = new ConfigSetting(config, "auction setting.auction house item click cooldown", 500, "How many milliseconds should pass before a player can click another auction item? This prevents spam clicking and server lag. use -1 to disable");
	public static final ConfigSetting MAIN_AH_REFRESH_BUTTON_COOLDOWN = new ConfigSetting(config, "auction setting.auction house refresh button cooldown", 1000, "How many milliseconds should pass before a player can click the refresh button again? This prevents spam clicking and server lag. use -1 to disable");
	...
	public static final ConfigSetting ASK_FOR_PURCHASE_CONFIRMATION = new ConfigSetting(config, "auction setting.ask for purchase confirmation", true, "Should Auction House open the confirmation menu for the user to confirm", "whether they actually meant to purchase the item or not?");
	...
	public static final ConfigSetting GUI_SELL_AUCTION_ITEM_ITEMS_FEE_ITEM = new ConfigSetting(config, "gui.sell auction item.items.fee.item", "https://textures.minecraft.net/texture/a4e1da882e434829b96ec8ef242a384a53d89018fa65fee5b37deb04eccbf10e");
	public static final ConfigSetting GUI_SELL_AUCTION_ITEM_ITEMS_FEE_NAME = new ConfigSetting(config, "gui.sell auction item.items.fee.name", "&e&lListing Fee");
	public static final ConfigSetting GUI_SELL_AUCTION_ITEM_ITEMS_FEE_LORE = new ConfigSetting(config, "gui.sell auction item.items.fee.lore", Arrays.asList(
			"&cThere is a listing fee to list this item.",
			"",
			"&7Rate&f: &a%listing_fee%",
			"",
